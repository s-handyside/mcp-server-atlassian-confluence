...
// my-node-package greet --name "JavaScript User"
...
const { executeCli } = require('@aashari/boilerplate-npm-package');
...
process.argv = ['node', 'script.js', 'greet', '--name', 'Programmatic User'];
executeCli();
